  /*
  能发送异步ajax请求的函数模块封装axios库。函数的返回值是promise对象
  1. 优化1: 统一处理请求异常? 在外层包一个自己创建的promise对象。在请求出错时, 不reject(error), 而是显示错误提示。
  2. 优化2: 异步得到不是reponse, 而是response.data。在请求成功resolve时: resolve(response.data)
 */
